 ...
 */
class LiveTVCardPresenter(context: Context, themeResID: Int) :
    ...
    override fun onBindViewHolder(card: Any, cardView: NewImageCardView) {
        ...
        val data = card as LiveTVItemModel

        if (!TextUtils.isEmpty(card.free) && card.free
                .equals("0")
        ) {
