...
class LoadingCardView : BaseCardView {
    ...
    private fun buildLoadingCardView(styleResId: Int) {
        ...
        if (screenWidth == 1280 && screenHeight == 720) {
            mProgressContainer!!.layoutParams.width = 238
            mProgressContainer!!.layoutParams.height = 134
        } else {
            mProgressContainer!!.layoutParams.width = 356
            mProgressContainer!!.layoutParams.height = 200
        }
        cardAttrs.recycle()
    }
